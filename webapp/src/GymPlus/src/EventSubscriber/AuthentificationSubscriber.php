...
class AuthentificationSubscriber implements EventSubscriberInterface
{
    ...
    {   
        ...
        */
        ...
        , 'app_produit_indexAdmin', 'app_panier' , 'app_livraison_index' , 'app_facture_index' , 'app_notif_index'];
        ...
        , 'app_produit_indexAdmin', 'app_livraison_index' , 'app_facture_index', 'app_notif_index'];
