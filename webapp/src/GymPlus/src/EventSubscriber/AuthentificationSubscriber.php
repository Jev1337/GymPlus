...
class AuthentificationSubscriber implements EventSubscriberInterface
{
    ...
    {   
        ...
        */
        ...
        , 'app_usermgmt', 'app_user_delete', 'app_user_edit', 'app_photo_admin', 'app_submgmt', 'app_removesub', 'app_subuser', 'app_user_delete_current' , 'app_updatefaceid', 'app_produit_index'
        , 'app_produit_indexAdmin', 'app_panier' , 'app_livraison_index' , 'app_facture_index' , 'app_notif_index','eventParticipant
        ...
        $clientRoutes = ['app_home', 'app_subs', 'app_buy', 'app_profile', 'app_objectif', 'app_Schedule_objectif', 'event_join', 'event_leave','app_eventsf','getAll_post','get_conversation','rewards','points','belt','bag','whey', 'app_produit_index'
        , 'app_panier','past_events','event_vote'];
        ...
        , 'app_produit_indexAdmin', 'app_livraison_index' , 'app_facture_index', 'app_notif_index','past_events_history'];
