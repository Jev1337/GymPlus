...
class AuthentificationSubscriber implements EventSubscriberInterface
{
    ...
    {   
        ...
        */
        ...
        $clientRoutes = ['app_home', 'app_subs', 'app_buy', 'app_profile', 'app_objectif', 'app_Schedule_objectif', 'event_join', 'event_leave','app_eventsf'];
        ...
        $adminRoutes = array_merge($adminRoutes, 
            ['app_usermgmt', 'app_user_delete', 'app_user_edit']
        );
