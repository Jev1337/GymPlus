...
(5, 'produit1', 2.5, 23, 'food1', 'food', 'azertyuiop', 2, 0.05);
...
--
ALTER TABLE `abonnement`
  ADD CONSTRAINT `abonnement_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
...
--
ALTER TABLE `maintenances`
  ADD CONSTRAINT `maintenances_ibfk_1` FOREIGN KEY (`equipements_details_id`) REFERENCES `equipements_details` (`id`);

--
-- Contraintes pour la table `objectif`
--
ALTER TABLE `objectif`
  ADD CONSTRAINT `objectif_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `objectif_ibfk_2` FOREIGN KEY (`coachId`) REFERENCES `user` (`id`);
...
ALTER TABLE `planning`
  ...
  ADD CONSTRAINT `planning_ibfk_2` FOREIGN KEY (`idCoach`) REFERENCES `user` (`id`);
