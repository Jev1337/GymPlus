...
class ConversationRepository extends ServiceEntityRepository
{
    ...
    //        ;
    //    }
    public function findConversationByParticipants($idOtherUser, $idUser)
    {
    ...
    public function findConversationByUser($id)
    {
        $qb = $this->createQueryBuilder('c');
    ...
    public function checkIfUserIsParticipant(int $convoId, int $userId)
    {
