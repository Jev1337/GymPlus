...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 13 mai 2024 à 22:14
...
INSERT INTO `detailfacture` (`idFacture`, `idDetailFacture`, `idProduit`, `prixVenteUnitaire`, `quantite`, `tauxRemise`, `prixTotalArticle`) VALUES
(1, 1, 6, 30, 1, 0, 30),
(2, 1, 6, 30, 1, 0, 30),
(3, 1, 5, 800, 1, 0, 800),
(4, 1, 4, 900, 1, 0, 900),
...
INSERT INTO `facture` (`idFacture`, `dateVente`, `prixTatalPaye`, `methodeDePaiement`, `id`) VALUES
(1, '2024-05-13', 830, 'Card', 12340000),
(2, '2024-05-13', 30, 'cheque', 12345632),
(3, '2024-05-13', 800, 'carte', 12345632),
(4, '2024-05-13', 900, 'carte', 12345632);
...
INSERT INTO `livraison` (`idLivraison`, `idFacture`, `idClient`, `Lieu`, `etat`) VALUES
(8, 1, 12345632, 'Cité de Londres, Royaume-Uni', 'Delivered'),
(9, 2, 12345632, 'Atlantia do Norte', 'Delivered'),
(10, 3, 12345632, 'Richards Bay', 'Delivered'),
(11, 4, 12345632, 'Cumaribo', 'In progress');
...
(3, 'All products have sufficient stock.', 'Unread', NULL, 'sufficient stock', NULL, NULL, '2024-05-13'),
(4, 'All products have sufficient stock.', 'Completed', NULL, 'sufficient stock', NULL, NULL, '2024-05-13'),
(6, 'All products have sufficient stock.', 'Unread', NULL, 'sufficient stock', NULL, NULL, '2024-05-13'),
(7, 'All products have sufficient stock.', 'Unread', NULL, 'sufficient stock', NULL, NULL, '2024-05-13'),
(8, 'All products have sufficient stock.', 'Unread', NULL, 'sufficient stock', NULL, NULL, '2024-05-13'),
(9, 'All products have sufficient stock.', 'Unread', NULL, 'sufficient stock', NULL, NULL, '2024-05-13'),
(10, 'All products have sufficient stock.', 'Unread', NULL, 'sufficient stock', NULL, NULL, '2024-05-13'),
(11, 'good product', 'Unread', 'yes', 'Comment', 'rania', 6, '2024-05-13'),
(12, 'wawww', 'Unread', 'yes', 'Comment', 'ilyes', 5, '2024-05-13'),
(13, 'All products have sufficient stock.', 'Unread', NULL, 'sufficient stock', NULL, NULL, '2024-05-13');
...
INSERT INTO `produit` (`idProduit`, `name`, `prix`, `stock`, `description`, `categorie`, `photo`, `seuil`, `promo`) VALUES
(1, 'alter5Kg', 100, 100, 'alter5Kg', 'equipement', 'alter5Kg.jpg', 10, 0.5),
(2, 'DoubleChocolat2Kg', 50, 60, 'Double Chocolat 2Kg', 'food', 'DoubleChocolat2Kg.jpg', 3, 0),
(3, 'espadrille Nike', 500, 550, 'espadrille Nike', 'equipement', 'espadrille Nike.png', 3, 0),
(4, 'NikeDunkLowPremium', 900, 999, 'Nike DunkLow Premium', 'vetement', 'NikeDunkLowPremium.png', 100, 0),
(5, 'Nikenoire', 800, 598, 'Nike noire', 'vetement', 'Nikenoire.png', 20, 0),
(6, 'sweatCapucheOversize', 30, 198, 'sweat Capuche Oversize', 'vetement', 'sweatCapucheOversize.png', 1, 0),
(8, 'Tournament Gloves', 40, 400, 'Tournament Gloves', 'equipement', 'Tournament Gloves.jpg', 3, 0.5);
